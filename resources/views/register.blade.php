        ...
        <div class="container-fluid">
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <form class="bg-light rounded p-4 p-sm-5 my-4 mx-3" action="{{route('registering')}}" method="post">
                        @csrf
                        ...
                        @enderror
                        <div class="form-floating mb-4">
                            <input type="password" class="form-control" name="confpass" id="floatingPassword" placeholder="Password">
                        ...
                        <p class="text-center mb-0">have a already account <a href="{{route('login')}}">Sign In</a></p>
                        @if (session('error'))
